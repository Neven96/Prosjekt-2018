      ...
      return (
        <div>
          <div className="navbar">
            <hr />
            <span className="spanbar"><NavLink exact to="/hjem" className="menyLinker" className="menyLinker" replace>Hjem</NavLink> </span>
            <span className="spanbar"><NavLink exact to="/hjelp" className="menyLinker" className="menyLinker" replace>Hjelp</NavLink> </span>
            <span className="spanbar"><NavLink exact to="/logginn" className="menyLinker" className="menyLinker" replace>Logg inn</NavLink></span>
            <hr />
          </div>
        </div>
      );
